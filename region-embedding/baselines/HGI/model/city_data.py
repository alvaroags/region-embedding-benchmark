...
def hgi_graph(city_name='SF'):
    ...
    city_dict_file = f'/content/drive/MyDrive/Colab_Notebooks/region-embedding-benchmark/region-embedding/baselines/HGI/data/{city_name}_hgi_data.pkl'
